	...
	public void diplayRecord() {
		...
		while(true)
		{
			...
			case 1:	System.out.println("Diplay All Record:-");
					...
					Query<Employee> query=session.createNamedQuery("diplay1");
			...
			case 2: System.out.println("Enter Employee Id:-");
					...
					Query<Employee> query1=session.createNamedQuery("diplay2");
...
//					System.out.println(emp1.getAddress());
			...
			case 3: System.out.println("Enter Department And Address:-");
					...
					Query<Employee> query2=session.createNamedQuery("diplay3");
			...
			case 4: System.out.println("Enter two Salary between to get data:-");
					...
					Query<Employee> query3=session.createNamedQuery("diplay4");
...
//						List list=query.list();//will return the records from 5 to 10th number  
			...
			case 5:	System.out.println("Enter First Latter:-");
					...
					Query<Employee> query4=session.createNamedQuery("diplay5");
...
//--------------------------------------------------UpdateRecord-----------------------------------------------------------
	...
	public void updateRecord() {
		...
		Query<Employee> query= session.createNamedQuery("update1");
...
//--------------------------------------------------deleteRecord-----------------------------------------------------------
		...
		//	String sql = "delete from Employee where empid=:id";
			...
			Query<Employee> query = session.createNamedQuery("delete1");
